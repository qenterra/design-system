...
COPY: dict[str, dict[str, Any]] = {
    "en": {
        ...
        "pages": {
            ...
            "products": ("Products", "Cadence, Unspool, Lilt, app icons, and migration priorities."),
        ...
        "ui": {
            ...
            "hero_summary": "Adaptive Soft Graphite, native behavior, honest state, short motion, and explicit recovery for Cadence, Unspool, Lilt, and whatever comes next.",
    ...
    "ru": {
        ...
        "pages": {
            ...
            "products": ("Продукты", "Cadence, Unspool, Lilt, иконки приложений и приоритеты миграции."),
        ...
        "ui": {
            ...
            "hero_summary": "Адаптивный Soft Graphite, нативное поведение, честные состояния, короткая анимация и явное восстановление для Cadence, Unspool, Lilt и будущих продуктов.",
...
SPECIMENS: dict[str, dict[str, Any]] = {
    "en": {
        ...
        "field": ["Collection name", "Evening listening", "Saved locally in Cadence.", "API ID", "not-a-number", "Enter a positive numeric API ID."],
    ...
    "ru": {
        ...
        "field": ["Название коллекции", "Вечернее прослушивание", "Сохранено локально в Cadence.", "API ID", "не-число", "Введите положительный числовой API ID."],
