...
Для графики Nyx, стикеров, обоев и pet-анимации дополнительно прочитайте `docs/brand/MASTER.ru.md`, нужный профиль Nyx и `assets/brand/manifest.json`. Nyx — единственное сохранённое семейство бренд-ассетов; графика не заменяет семантические UI-токены.
