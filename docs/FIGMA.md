...
`generated/figma/` is a deterministic bridge from canonical QDS sources into design-tool automation. It is not a second source of truth and does not claim that a Figma library was published.
...
Never edit generated exports. Change tokens or registries, run `python3 scripts/build.py`, inspect the JSON diff, and verify deterministic output.
