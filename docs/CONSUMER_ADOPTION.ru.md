...
Отчёт проверяет заявленные локальные адаптеры, границы исходников, сырые цвета и узко документированные исключения. Скрипт не меняет продукт и отказывается записывать отчёт внутрь дерева consumer.
