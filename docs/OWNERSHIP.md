...
Keep this map aligned with `.github/CODEOWNERS`, package manifests, deployment ownership, and maintainer records. Shared ownership does not mean ownerless work.
