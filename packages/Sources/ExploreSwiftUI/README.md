...
QenTerra has permission from the resource owner to publish these examples in this repository. The source is attributed to Explore SwiftUI and remains subject to the rights and terms of its original owner; it is not presented as QenTerra-authored code or silently relicensed by the repository's Apache-2.0 license.
