...
Every deprecation identifies the affected API or artifact, replacement, first deprecated version, warning mechanism, support window, planned removal version, and migration guide.
