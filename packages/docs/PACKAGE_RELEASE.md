...
- Swift Package Manager: `https://github.com/QenTerra/design-system`, products `QenTerraDesignTokens` and `QenTerraComponents`, metadata in `Package.swift`.
...
6. Confirm the license, applicable third-party notices, changelog, supported versions, deprecations, and migration notes.
