...
QenTerra Packages 5.4.0 declares no third-party runtime dependencies. It bundles exact source-reference catalogs from [Explore SwiftUI](https://exploreswiftui.com/), [Magic UI](https://magicui.design/docs/components), [shadcn/ui](https://github.com/shadcn-ui/ui), and [UIable](https://uiable.com/components).
